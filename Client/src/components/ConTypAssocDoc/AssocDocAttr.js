...
import AssocDocAttrCSS from "./AssocDocAttr.module.css";
  ...
  return (
    <div>
      <Row className="mt-lg-5 mt-3">
        <Col lg={3} xs={9} md={4}>
          <div className={AssocDocAttrCSS.dualListBox}>
            <div className={`pt-3 ps-4 pb-2 ${AssocDocAttrCSS.dualHead}`}>
              <h4 className={AssocDocAttrCSS.dualHeadFont}>
                Available Attributes
              </h4>
              <form>
                <input
                  className={AssocDocAttrCSS.attSearch}
                  type="text"
                  name="search"
                  placeholder="Search.."
                />
            ...
            <div className={AssocDocAttrCSS.leftList}>
              <ul ref={avaiAttrRef}>
                {availableOptions
                  .filter((val, id, array) => {
                  ...
                  .map((option) => (
                    <li key={option}>
                      <label className={AssocDocAttrCSS.LabelAdjustment}>
                        <input
                          type="checkbox"
                          id={option}
                          value={option}
                          className={AssocDocAttrCSS.checkStyle}
                        />
            ...
            <div className={AssocDocAttrCSS.buttonContainer}>
              <button
                className={AssocDocAttrCSS.DualArrowBtn}
        ...
        <Col lg={4} xs={9} md={4}>
          <div className={AssocDocAttrCSS.dualListBox}>
            ...
            <div className={` mt-3 mt-lg-0 ${AssocDocAttrCSS.rightList}`}>
              <ul ref={selAttrRef}>
                {selectedOptions
                  .filter((val, id, array) => {
                    return array.indexOf(val) === id;
                  ...
                  .map((option) => (
                    <li key={option} className={AssocDocAttrCSS.parentList}>
                      <label className={AssocDocAttrCSS.LabelAdjustment}>
                        <input
                          type="checkbox"
                          id={option}
                      ...
                      <input
                        ...
                        className={`${AssocDocAttrCSS.radioStyle}`}
                      />
                    </li>
                  ))}
              </ul>
        ...
        {selectedOptions.length > 0 && selectedAttribute && (
          <Col lg={5}>
            <Form onSubmit={handleSubmit} className={AssocDocAttrCSS.AsDocForm}>
              ...
              <Form.Group as={Row} className="mb-3" controlId="formIsGolbal">
                <Form.Label column lg="4" md="6" xs="12">
                  Is Golbal
                </Form.Label>
                <Col lg="8" md="6" xs="12">
              ...
              <Form.Group as={Row} className="mb-3" controlId="formHTMLPrompt">
                ...
                <Col lg="8" md="6" xs="6" name="HTMLPrompt">
                  <FaEye className={AssocDocAttrCSS.FaEye} />
                </Col>
              </Form.Group>
              ...
              >
                <Form.Label column lg="4" md="6" xs="6">
                  form IsConditional <FaRegQuestionCircle />
                </Form.Label>
                <Col>
                  <BootstrapSwitchButton
