...
const AssocDocTeam = (props) => {
  ...
  return (
    <div className={`w3-animate-zoom  ${AssocDocCSS.padFormTable}`}>
      <Row className={AssocDocCSS.padInsideAdjustement}>
        <Col md={5}>
          <Form
            onSubmit={handleSubmitTeam}
            className={`justify-content-md-center ${AssocDocCSS.listsearchParent}`}
          >
            ...
            <div className={AssocDocCSS.listsearchchild}>
              {results // to remove duplicates strings
                ...
                .map((data, index) => (
                  <li
                    className={` ${AssocDocCSS.searchValues}`}
                    key={index}
        ...
        <Col md={7}>
          <table className="table table-bordered justify-content-md-center mt-4">
            <thead>
              <tr className={AssocDocCSS.TableHeading}>
                <th scope="col">Name</th>
                <th scope="col">Role</th>
                <th scope="col">Email</th>
                <th scope="col" className={AssocDocCSS.DeleteColumnAlign}>
                  Delete
                </th>
              </tr>
            </thead>
            <tbody>
              ...
              {teamMembers.map((member, index) => (
                <tr key={index}>
                  ...
                  <td>{member.role}</td>
                  <td>{member.email}</td>
                  <td className={AssocDocCSS.DeleteIconPlaced}>
                    <MdDeleteForever
                      className={AssocDocCSS.DeleteIcon}
